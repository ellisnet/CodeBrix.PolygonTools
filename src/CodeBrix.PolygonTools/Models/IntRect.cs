...
/// <summary>
/// An axis-aligned bounding rectangle expressed in integer coordinates.
/// </summary>
public struct IntRect
{
  ...
  /// <summary>
  /// Initializes a new <see cref="IntRect"/> with the supplied edge coordinates.
  /// </summary>
  /// <param name="l">The X coordinate of the left edge.</param>
  /// <param name="t">The Y coordinate of the top edge.</param>
  /// <param name="r">The X coordinate of the right edge.</param>
