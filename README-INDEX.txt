================================================================================
README-INDEX: CodeBrix.PolygonTools
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.PolygonTools.MitLicenseForever -- 2D polygon clipping and
      offsetting for .NET: the four boolean operations, four filling rules,
      inflate/deflate with miter, round and square joins, open-path clipping,
      PolyTree nesting, and the Simplify/Clean/Minkowski helpers.
